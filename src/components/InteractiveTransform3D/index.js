...
export default function InteractiveTransform3D() {
  ...
  return (
    <div className={styles.container}>
      ...
      <div ref={mountRef} className={styles.canvas} style={{ height: 400 }}></div>
      <div className={styles.controls}>
        ...
        <div className={styles.sliderGroup}>
          ...
          <input type="range" min="-5" max="5" step="0.1" value={position.y} onChange={e => handleSliderChange('position', 'y', e.target.value)} className={`${styles.slider} ${styles.sliderY}`} />
        </div>
        <div className={styles.sliderGroup}>
          <label className={styles.sliderLabel}>
          ...
          <input type="range" min="-5" max="5" step="0.1" value={position.z} onChange={e => handleSliderChange('position', 'z', e.target.value)} className={`${styles.slider} ${styles.sliderZ}`} />
        </div>
        ...
        <div className={styles.sliderGroup}>
          ...
          <input type="range" min={(-Math.PI).toFixed(2)} max={Math.PI.toFixed(2)} step="0.01" value={rotation.y} onChange={e => handleSliderChange('rotation', 'y', e.target.value)} className={`${styles.slider} ${styles.sliderY}`} />
        </div>
        <div className={styles.sliderGroup}>
          <label className={styles.sliderLabel}>
          ...
          <input type="range" min={(-Math.PI).toFixed(2)} max={Math.PI.toFixed(2)} step="0.01" value={rotation.z} onChange={e => handleSliderChange('rotation', 'z', e.target.value)} className={`${styles.slider} ${styles.sliderZ}`} />
        </div>
        <hr style={{ border: 'none', borderTop: '1px solid #222', margin: '1.5rem 0' }} />
        {/* Scale Controls */}
        <div className={styles.sliderGroup}>
        ...
        <div className={styles.sliderGroup}>
          ...
          <input type="range" min="0.2" max="3" step="0.01" value={scale.y} onChange={e => handleSliderChange('scale', 'y', e.target.value)} className={`${styles.slider} ${styles.sliderY}`} />
        </div>
        <div className={styles.sliderGroup}>
          <label className={styles.sliderLabel}>
          ...
          <input type="range" min="0.2" max="3" step="0.01" value={scale.z} onChange={e => handleSliderChange('scale', 'z', e.target.value)} className={`${styles.slider} ${styles.sliderZ}`} />
        </div>
