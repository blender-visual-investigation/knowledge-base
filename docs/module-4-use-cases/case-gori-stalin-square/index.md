...
- ✅ Basic Blender navigation (see [First Steps](/docs/module-1-blender/1-3-working-in-blender/first-steps))
- ✅ Camera positioning (see [Camera & Views](/docs/module-4-use-cases/working-with-models/camera-and-views))
- ✅ Import/export workflows (see [Importing Models](/docs/module-4-use-cases/working-with-models/importing-models))
- ✅ Measurement tools (see [Measurements](/docs/module-4-use-cases/working-with-models/measurements))
...
**Techniques Used:**
- [Camera Matching](/docs/module-3-tools-addons-techniques/techniques/camera-matching) for photo alignment
- [Image-Based Modeling](/docs/module-3-tools-addons-techniques/techniques/image-based-modeling) for textures
- [Establishing Scale & Dimension](/docs/module-3-tools-addons-techniques/techniques/establishing-scale-dimension)
